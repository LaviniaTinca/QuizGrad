      ...
      <Dialog>
        <DialogTrigger asChild>
          {!isFinished && (
            <Button
              ...
              className="text-lg font-bold py-4 px-8 rounded b-2 ml-auto h-12"
        ...
        >
          <div className="flex  justify-center items-center max-h-screen">
            ...
            <div className="bg-qyellow hover:bg-qyellow text-white rounded-full w-96 h-96 p-4 text-center font-bold items-center flex flex-col">
          ...
          <DialogFooter className="flex justify-end  sm:justify-end">
            ...
            >
              <Link
                to={"/"}
                className="flex-end"
                // className="border-none flex-end  text-dblue bg-dyellow hover:bg-white shadow-md p-4 rounded-lg"
              >
