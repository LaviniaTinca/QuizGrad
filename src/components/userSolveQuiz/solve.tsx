...
import { IdObject, UserQuiz } from "@shadcn/utils/typescript/models";
    ...
    <>
      <div>
        ...
        <div className="flex flex-col  max-h-screen justify-between mt-2">
          ...
          <div className="ml-8 mr-8 h-[500px] overflow-y-auto">
            <div className="text-center h-auto bg-qyellow text-white font-bold rounded-md  p-4 py-12 text-xl mb-8">
              <strong className="text-gray-100">Q{questionIndex}.</strong>{" "}
              {questions[currentQuestion].questionTitle}
            </div>
            <div className="flex flex-col items-center">
              <div className="flex flex-wrap gap-4 justify-left w-3/4 p-2">
                {questions[currentQuestion].answersOptions.map(
                  (option, index) => {
                    ...
                    const buttonClasses = twMerge(
                      "font-bold text-md py-4 px-8 rounded mr-2 mb-2 h-20 text-left relative",
                      // isSelected
                      //   ? "bg-qyellow text-white text-md "
                      //   : "border border-qyellow bg-white text-qorange"
                      isSelected
          ...
          <div className="flex justify-between items-center ml-72 mr-64">
            <div>
              <Button
                ...
                className="text-md font-bold py-4 px-4 rounded mb-2 mr-auto h-12"
            ...
            <div className="flex flex-row justify-end gap-4">
              {currentQuestion < questions.length - 1 ? (
                <Button
                  ...
                  className={`text-md font-bold py-4 px-4 mb-2 mr-auto h-12 ${
                    !canProceed && "cursor-not-allowed opacity-50"
                  }`}
                >
                  Next
